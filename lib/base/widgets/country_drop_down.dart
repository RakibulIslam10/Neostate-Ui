...
class CountryDropDown<T> extends StatefulWidget {
  ...
  @override
  _CountryDropDownState<T> createState() => _CountryDropDownState<T>();
}

class _CountryDropDownState<T> extends State<CountryDropDown<T>>
        ...
        child: Padding(
          ...
          child: Text(
            ...
            style: CustomStyle.titleMedium.copyWith(
              color:
                  widget.selectMethod.value == itemTitle ? Colors.black : null,
            ),
          ),
        ),
      ),
    ...
    return GestureDetector(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            height: widget.inputBoxHeight ?? Dimensions.inputBoxHeight * 1.1,
            decoration: widget.decoration ??
                BoxDecoration(
                  border: Border.all(
                    color: isDropdownOpened
                        ? CustomColor.primary
                        : CustomColor.disableColor.withOpacity(0.5),
  ...
  String _getItemTitle(T item) {
    if (item is CountryDropdownModel) {
      return item.title;
